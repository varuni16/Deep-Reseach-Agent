...
## 🔴 [Live Demo: Click Here to Try the App](https://deep-reseach-agent-8ddjhvbx9rlqducwd2w82m.streamlit.app/)
...
1.  **Search Agent:** Breaks down the user's topic into sub-queries (Overview, Details, Latest Updates) and finds high-quality sources using DuckDuckGo.
...
3.  **Synthesis Agent:** Compiles all gathered information into a structured, academic-format report with citations.
